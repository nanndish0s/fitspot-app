...
<body class="bg-gray-50 antialiased">
    ...
    <!-- Hero Section -->
    <section class="relative bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('storage/hero/hero-image.png') }}')">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="text-center lg:text-left text-white">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                        <a href="{{ route('services.index') }}" class="inline-flex items-center px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition duration-300 group">
                            <i class="fas fa-dumbbell mr-2 group-hover:animate-pulse"></i>
                            Explore Services
                        </a>
                        <a href="{{ route('products.index') }}" class="inline-flex items-center px-6 py-3 border border-white text-white rounded-lg hover:bg-white/10 transition duration-300 group">
                ...
                <div class="hidden lg:block text-center">
                    <img src="{{ asset('storage/hero/fitness-hero.png') }}" class="mx-auto rounded-full shadow-2xl max-w-sm" />
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center">
                                <span class="text-2xl font-bold text-green-600">LKR {{ number_format($product->price, 2) }}</span>
                                <a href="{{ route('products.show', $product->id) }}" class="inline-flex items-center px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition duration-300">
                                    View Details
                                </a>
                            </div>
                        </div>
