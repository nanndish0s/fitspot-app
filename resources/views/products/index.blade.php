<x-app-layout>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 d-none d-lg-block">
                    <img src="{{ asset('images/fitness-hero.png') }}" alt="Fitness Products" class="img-fluid hero-image">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col product-card" 
                    ...
                    <div class="card h-100 border-0 shadow-sm product-item">
                        ...
                        <div class="card-footer bg-transparent border-0 d-flex">
                            <form action="{{ route('cart.add', $product->id) }}" method="POST" class="flex-grow-1 me-2">
                                @csrf
                                <button type="submit" class="btn btn-primary w-100">
                                    <i class="fas fa-cart-plus me-2"></i>Add to Cart
                                </button>
                            </form>
                            <form action="{{ route('wishlist.store') }}" method="POST" class="flex-shrink-0">
                                @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const wishlistForms = document.querySelectorAll('form[action="{{ route("wishlist.store") }}"]');
