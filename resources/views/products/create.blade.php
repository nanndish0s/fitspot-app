        ...
        <div class="bg-white shadow-2xl rounded-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-green-500 to-green-700 px-6 py-8 text-white">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <a href="{{ route('seller.dashboard') }}" class="inline-flex items-center px-4 py-2 border border-white text-white rounded-md hover:bg-white hover:text-green-600 transition">
            ...
            {{-- Form --}}
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" x-data="productForm()" @submit.prevent="validateAndSubmit">
                @csrf
