            ...
            <div class="flex items-center space-x-4">
                ...
                @auth
                    <div x-data="{ profileDropdown: false }" class="relative">
                        ...
                        >
                            <div class="px-1 py-1">
                                <a href="{{ route('profile.edit') }}" class="text-gray-900 group flex rounded-md items-center w-full px-2 py-2 text-sm hover:bg-green-100">
                                    <i class="fas fa-user-cog mr-2"></i>Profile
                                </a>
                                @if(auth()->user()->role === 'trainer')
                                    <a href="{{ route('trainer.dashboard') }}" class="text-gray-900 group flex rounded-md items-center w-full px-2 py-2 text-sm hover:bg-green-100">
                                        <i class="fas fa-chalkboard-teacher mr-2"></i>Trainer Dashboard
                                    </a>
                                @endif
                                <a href="{{ route('wishlist.index') }}" class="text-gray-900 group flex rounded-md items-center w-full px-2 py-2 text-sm hover:bg-green-100">
                                    <i class="fas fa-heart mr-2"></i>Wishlist
                                </a>
                                <a href="{{ route('orders.index') }}" class="text-gray-900 group flex rounded-md items-center w-full px-2 py-2 text-sm hover:bg-green-100">
                                    <i class="fas fa-receipt mr-2"></i>My Orders
                                </a>
                                <a href="{{ route('bookings.index') }}" class="text-gray-900 group flex rounded-md items-center w-full px-2 py-2 text-sm hover:bg-green-100">
                            ...
                            <div class="px-1 py-1">
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit" class="w-full text-left text-red-600 py-2 flex items-center">
