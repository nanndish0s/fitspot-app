            ...
            <div class="row align-items-center">
                <div class="col-lg-6 text-center text-lg-start">
                    ...
                    <div class="d-flex justify-content-center justify-content-lg-start gap-3">
                        <a href="<?php echo e(route('services.index')); ?>" class="btn btn-success btn-lg">
                ...
                <div class="col-lg-6 text-center d-none d-lg-block">
                    <img src="<?php echo e(asset('storage/hero/fitness-hero.png')); ?>" alt="" class="img-fluid rounded-circle shadow-lg" style="max-width: 400px;">
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="h5 mb-0">LKR <?php echo e(number_format($product->price, 2)); ?></span>
                                    <a href="<?php echo e(route('products.show', $product->id)); ?>" class="btn btn-sm btn-success">View Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\Users\Nanndish\Desktop\CC - 2 Backup\fitspot-app\resources\views/home.blade.php ENDPATH**/ ?>