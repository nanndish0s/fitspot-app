                    ...
                    <?php $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="py-4 flex justify-between items-center hover:bg-gray-50 transition duration-150 ease-in-out">
                            <div class="flex items-center space-x-4">
                                <div class="flex-shrink-0">
                                    <img class="h-12 w-12 rounded-full object-cover" 
                                         src="<?php echo e($chat->user->profile_picture ? Storage::url($chat->user->profile_picture) : asset('images/default-avatar.png')); ?>" 
                                         alt="<?php echo e($chat->user->name); ?>">
                                </div>
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900"><?php echo e($chat->user->name); ?></h3>
                                    <p class="text-sm text-gray-500 max-w-md truncate">
                                        <?php echo e($chat->last_message); ?>

                                    </p>
                                    <?php if($chat->created_at): ?>
                            ...
                            <div class="flex items-center space-x-3">
                                <button 
                                    x-data 
                                    x-on:click="$dispatch('open-chat', { userId: <?php echo e($chat->user->id); ?> })"
            ...
            return {
                ...
                renderMessages() {
                    ...
                    messagesContainer.innerHTML = this.messages.map(msg => `
                        <div class="mb-2 p-2 ${msg.sender_id === <?php echo e(auth()->id()); ?> ? 'text-right bg-blue-100' : 'text-left bg-gray-100'} rounded-md">
                            <p>${msg.message}</p>
...
<?php /**PATH C:\Users\Nanndish\Desktop\Sprint 3\fitspot-app\resources\views/trainers/dashboard.blade.php ENDPATH**/ ?>