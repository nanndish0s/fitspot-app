...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <a href="<?php echo e(route('services.index')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-50 text-indigo-700 rounded-lg hover:bg-indigo-100 transition duration-300 group">
                ...
                <div class="md:col-span-2 space-y-8">
                        ...
                        <div class="flex flex-col md:flex-row items-start space-y-4 md:space-y-0 md:space-x-6">
                            ...
                            <div class="w-full md:w-1/3">
                                <?php if($service->image): ?>
                                    <img src="<?php echo e(Storage::url($service->image)); ?>" 
                            ...
                            <div class="w-full md:w-2/3 space-y-4">
                                ...
                                <div class="flex space-x-4 mt-6">
                                    ...
                                    <a href="<?php echo e(route('trainers.profile', ['trainer' => $service->trainer->id])); ?>" 
                    ...
                    <div class="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-8 border border-gray-100">
                        ...
                        <div class="flex items-center space-x-6">
                            <?php if($service->trainer->profile_picture): ?>
                                <img src="<?php echo e(Storage::url($service->trainer->profile_picture)); ?>" 
                                     alt="<?php echo e($service->trainer->user->name); ?>" 
                            ...
                            <?php endif; ?>
                            <div>
                                <h4 class="text-xl font-bold text-indigo-600"><?php echo e($service->trainer->user->name); ?></h4>
                                <p class="text-gray-600"><?php echo e($service->trainer->bio); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="space-y-6">
                                <?php $__currentLoopData = $relatedServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="bg-indigo-50 rounded-2xl p-4 hover:bg-indigo-100 transition duration-300">
                                        <a href="<?php echo e(route('services.show', $relatedService)); ?>" class="block">
                                            <div class="flex justify-between items-center">
                                                <div>
                                                    <h4 class="text-lg font-semibold text-gray-900"><?php echo e($relatedService->service_name); ?></h4>
                                                    <p class="text-sm text-gray-600"><?php echo e($relatedService->trainer->specialization); ?></p>
                                                </div>
                                                <span class="text-indigo-600 font-bold">
                                                    LKR <?php echo e(number_format($relatedService->price, 2)); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Nanndish\Desktop\Sprint 3\fitspot-app\resources\views/services/show.blade.php ENDPATH**/ ?>