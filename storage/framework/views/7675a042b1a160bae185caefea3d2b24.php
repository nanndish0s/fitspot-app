                            ...
                            <div class="text-gray-700 space-y-2">
                                <p class="text-lg">
                                    ...
                                    <span class="inline-block px-3 py-1 bg-indigo-50 text-indigo-700 rounded-full text-sm ml-2">
                                        <?php echo e($trainer->specialization); ?>
                                ...
                                <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 overflow-hidden">
                                    <div class="p-6 space-y-4">
                                        <div class="flex justify-between items-start">
                                            <div>
                                                <div class="text-xl font-bold text-gray-900 mb-2"><?php echo e($service->service_name); ?></div>
                                                <p class="text-gray-600 text-sm"><?php echo e($service->description); ?></p>
                                            </div>
                                        ...
                                        <?php if(auth()->guard()->check()): ?>
                                            <div class="flex justify-end space-x-4 mt-4">
                                                ...
                                                <button data-test="chat-with-trainer" x-data x-on:click="$dispatch('open-chat', { trainerId: <?php echo e($trainer->user->id); ?> })"
                                        ...
                                        <?php else: ?>
                                            <div class="flex justify-end space-x-4 mt-4">
                                                ...
                                                <button x-data x-on:click="$dispatch('open-chat', { trainerId: <?php echo e($trainer->user->id); ?> })"
                                                   class="px-5 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-300 flex items-center space-x-2 text-sm font-medium">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                                    </svg>
...
<?php endif; ?>
<?php /**PATH C:\Users\Nanndish\Desktop\Sprint 3\fitspot-app\resources\views/trainers/profile.blade.php ENDPATH**/ ?>