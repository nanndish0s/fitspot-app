                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="price_range" name="price_range" 
                                    ...
                                    <option value="2000+" <?php echo e(($filters['price_range'] ?? '') == '2000+' ? 'selected' : ''); ?>>Over LKR 2,000</option>
                                </select>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input type="text" 
                                           id="location" 
                                           name="location" 
                                           value="<?php echo e($filters['location'] ?? ''); ?>"
                                    ...
                                    <input type="hidden" id="latitude" name="latitude" value="<?php echo e($filters['latitude'] ?? ''); ?>">
                                    <input type="hidden" id="longitude" name="longitude" value="<?php echo e($filters['longitude'] ?? ''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="distance" name="distance" 
                                    ...
                                    <option value="5" <?php echo e(($filters['distance'] ?? '') == '5' ? 'selected' : ''); ?>>Within 5 km</option>
                                    <option value="10" <?php echo e(($filters['distance'] ?? '') == '10' ? 'selected' : ''); ?>>Within 10 km</option>
                                    <option value="20" <?php echo e(($filters['distance'] ?? '') == '20' ? 'selected' : ''); ?>>Within 20 km</option>
                                    <option value="50" <?php echo e(($filters['distance'] ?? '') == '50' ? 'selected' : ''); ?>>Within 50 km</option>
                                </select>
                            </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center text-sm text-gray-500 mb-2">
                                    ...
                                    <span><?php echo e(number_format($service->distance, 1)); ?> km away</span>
                                </div>
                                <?php endif; ?>
                                <!-- Service Highlights -->
                            ...
                            <div class="space-y-4 mb-6">
                                ...
                                <?php if($service->trainerService): ?>
                                    <div class="flex items-center justify-between mt-4">
                                        <span class="text-lg font-bold text-primary">
                                            $<?php echo e(number_format($service->trainerService->price, 2)); ?>

                                        </span>
                                        <div class="flex space-x-2">
                                            <form action="<?php echo e(route('wishlist.store')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="service_id" value="<?php echo e($service->trainerService->id); ?>">
                                            ...
                                            <a href="<?php echo e(route('services.book', $service->trainerService->id)); ?>" class="bg-primary text-white px-3 py-1 rounded hover:bg-primary-dark transition">
                                                Book Now
                                            </a>
                                        </div>
                                    </div>
...
<?php /**PATH C:\Users\Nanndish\Desktop\Sprint 3\fitspot-app\resources\views/services/index.blade.php ENDPATH**/ ?>